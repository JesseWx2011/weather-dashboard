...
tempC = response[0].periods[0].tempC
      ...
      document.getElementById('icon').innerHTML = `<img src="../icons/${response[0].periods[0].icon}" style="width: 10%; padding-left: 590px; display: flex;"></img>`;
   ...
   async function getForecast() {
      ...
      document.getElementById('wxicon2').innerHTML = `<img src="../icons/${response[0].periods[2].icon}"></img>`;
      ...
      document.getElementById('wxicon3').innerHTML = `<img src="../icons/${response[0].periods[3].icon}"></img>`;
      ...
      document.getElementById('wxicon4').innerHTML = `<img src="../icons/${response[0].periods[4].icon}"></img>`;
      ...
      document.getElementById('wxicon5').innerHTML = `<img src="../icons/${response[0].periods[5].icon}"></img>`;
      ...
      document.getElementById('wxicon6').innerHTML = `<img src="../icons/${response[0].periods[6].icon}"></img>`;
